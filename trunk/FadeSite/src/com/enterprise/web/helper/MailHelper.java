...
public class MailHelper {
	...
	private static final String SMTP_USERNAME = "cs9321.team.fade@gmail.com";
	private static final String SMTP_PASSWORD = "team.fade";
	...
	public static void PostMail( String recipient, String subject, String message) throws MessagingException
	{
		...
		Message msg = new MimeMessage(session);
		InternetAddress addressFrom = new InternetAddress("cs9321.team.fade@gmail.com");
		msg.setFrom(addressFrom);
