...
%>
<%
String contentPage = "/events/manage.jsp";

if (request.getParameter("fromMasterPage") == null)
{
%>
<jsp:forward page="../masterpage.jsp">
	<jsp:param name="pageTitle" value="Manage My Events" />
...
<% List<EventEntity> events = EventDAO.listPublicEventByUserId(user.getUserId()); %>
		...
		%>
			<div style='width: 90%; margin: 30px; margin-bottom:75px;'>
				...
				<div style='font-size: 13px; margin-top: 10px;'>
					...
					<% if (user.getUserId() > 1 && user.getUserId() > 1)
						{%>
