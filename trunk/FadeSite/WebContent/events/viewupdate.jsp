...
<%
String contentPage = "/events/viewupdate.jsp";

if (request.getParameter("fromMasterPage") == null)
{
%>
<jsp:forward page="../masterpage.jsp">
	<jsp:param name="pageTitle" value="View Event Update" />
...
<div style='margin-left: 20px'>
		...
		<table id="formTable" style='float:left; margin-top: 50px;'>
			...
			<tr>
				...
				<td>
					<textarea name='description' class='disabledTextBox' disabled="disabled"><%= event.getDescription() %></textarea>
				</td>
			</tr>
			<tr>
