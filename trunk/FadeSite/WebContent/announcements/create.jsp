...
<%
String contentPage = "/announcements/create.jsp";

if (request.getParameter("fromMasterPage") == null)
{
%>
<jsp:forward page="../masterpage.jsp">
	<jsp:param name="pageTitle" value="Create Announcement" />
	...
	<form method='POST' autocomplete='off' name="frmAnnouncement" action='dispatcher'>
		...
		<table id="formTable">
			...
			<tr>
				...
				<td>
					<input type='text' class="datepicker" name='expirydate'></input>
					<label class="reqText">*</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div style='margin-top:15px;'>
						<textarea name='content' class="html"></textarea>
					</div>
