...
<%
String contentPage = "/activities/view.jsp";

if (request.getParameter("fromMasterPage") == null)
{
%>
<jsp:forward page="../masterpage.jsp">
	<jsp:param name="pageTitle" value="View Activity" />
...
%>
  ...
  <% ActivityEntity activity = (ActivityEntity)request.getAttribute("activity");%>
	...
	<div class='subMenu'>
		<a href='<%= "dispatcher?section=activities&action=delete&activityId=" + activity.getActivityID() %>'>Delete Activity</a> |
		<a href='<%= "dispatcher?section=activities&action=edit&activityId=" + activity.getActivityID() %>'>Edit Activity</a>
	</div>
...
<div class='subMenu' style='width: 90%; float: none;'>
	<a href="dispatcher?section=activities&action=list">Back</a>
</div>
