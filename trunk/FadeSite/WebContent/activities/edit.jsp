...
<%
String contentPage = "/activities/edit.jsp";

if (request.getParameter("fromMasterPage") == null)
{
%>
<jsp:forward page="../masterpage.jsp">
	<jsp:param name="pageTitle" value="Edit Activity" />
	...
	<form method='POST' autocomplete='off' name="frmActivity" action='dispatcher'>
		...
		<table id="formTable" style='float:left; margin-top: 30px;'>
			<tr>
				...
				<td>
					<input type='text' name='name' value='<%= activity.getName() %>'></input>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input type='text' name='position' value='<%= activity.getPosition() %>'></input>
			...
			<tr>
				...
				<td>
					<input type='text' name='project' value='<%= activity.getProject() %>'></input>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input type='text' name='organization' value='<%= activity.getOrganisation() %>'></input>
					<label class="reqText">*</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type='text' name='location' value='<%= activity.getLocation() %>'></input>
					<label class="reqText">*</label>
			...
			<tr>
				...
				<td>
					<input type='text' class='datepicker' name='startdate' value='<%= activity.getStartDateString() %>'></input>
					<label class="reqText">*</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type='text' class='datepicker' name='enddate' value='<%= activity.getEndDateString() %>'></input>
				</td>
			</tr>
			<tr>
				<td valign='top'>
				...
				<td>
					<textarea name='description' style='width: 200px; height: 100px;'><%= activity.getDescription() %></textarea>
				</td>
			</tr>
			<tr>
